...
* **Primary 1 Third Term — Cultural and Creative Arts authored (4 of 11).** Eight weeks: patterns and design, printmaking, weaving and basketry, pottery and clay work, folk songs and rhymes, cultural dances, puppetry and masquerade, our cultural heritage. sheet_check clean, make_exam --strict PASS (A=8 B=7 C=8 D=7, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 1 Third Term — General Knowledge authored (5 of 11).** Eight weeks: transportation, communication, money and trade, natural resources, technology around us, rules and laws, being a responsible child, our neighbours and the world. sheet_check clean, make_exam --strict PASS (A=8 B=8 C=7 D=7, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 1 Third Term — Nigerian History authored (6 of 11).** Eight weeks: Nigeria's independence, our first leaders, unity in diversity, Nigerian languages, traditional religion and beliefs, trade in the past, Nigeria today, being a good Nigerian. Two fixes (a paper answer's traps made real names so it is not the guessable long one; wk4 'My own work' got a hands verb). sheet_check clean, make_exam --strict PASS (A=7 B=8 C=8 D=7, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 1 Third Term — Physical and Health Education authored (7 of 11).** Eight weeks: balance and coordination, ball skills (striking/kicking), relay races, water safety, simple first aid, care of my teeth and skin, saying no to harmful things, fitness and games. One fix (wk2 repeated wk1's 'we practise' line — made it ball-skill specific). sheet_check clean, make_exam --strict PASS (A=8 B=7 C=7 D=8, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 1 Third Term — Prevocational Studies authored (8 of 11).** Eight weeks: work at home and in the community, simple food preparation, care of clothing, crafts (making things), caring for our environment, animals and their care, saving and spending, work we may do when we grow up. sheet_check clean, make_exam --strict PASS (A=7 B=8 C=8 D=7, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 1 Third Term — Social and Citizenship Studies authored (9 of 11).** Eight weeks: our country Nigeria, our national symbols, our culture and customs, our rights and duties, living together in peace, respect for leaders and elders, caring for our community, being a good citizen. sheet_check clean, make_exam --strict PASS (A=8 B=8 C=7 D=7, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 1 Third Term — Yoruba authored (10 of 11).** Nine weeks (W1-6,8,9,11): orí ọ̀rọ̀ (tones), kíka títí dé ọgọ́rùn-ún (counting to 100), ọjọ́ àti oṣù (days and months), ọjà (market), oúnjẹ (food), ẹranko (animals), òwe (proverbs), orin (songs), ìtàn (stories). Four 'My own work' blocks got a hands verb (trace). sheet_check clean, make_exam --strict PASS (A=7 B=8 C=8 D=7, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 1 Third Term — Mathematics & English authored (11 of 11 — ALL SUBJECTS DONE).** Two streams on the master topics. MATHEMATICS (8 wks): weight, capacity, area (intro), 2-D shapes, 3-D shapes, data collection, review of geometry, applied problem solving. ENGLISH LANGUAGE (8 wks): comprehension of short stories and poems, asking/answering on past and future actions, adjectives, listening comprehension, comprehension of everyday situations, present continuous tense, vocabulary building and spelling, phonemic awareness and listening. Fixes: ENG sub8 given a second acceptable answer; three 'My own work' blocks got hands verbs; wk5 repeat reworded. sheet_check clean, both make_exam --strict PASS (MATH A=8 B=7 C=7 D=8; ENG A=7 B=8 C=8 D=7, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 1 Third Term — BOOKS BUILT, TERM COMPLETE.** Pupil copy `notes/Primary 1 - Third Term.{md,docx}` (195,883 B md / 111,940 B docx, 98 pages, 12 papers, key n=360 A=92 B=90 C=90 D=88) and teacher copy `notes/Primary 1 - Third Term - TEACHER COPY.{md,docx}` (208,584 B md / 117,644 B docx, 110 pages, paper keys only). Both built --strict, rule checks all clear, gates ALL CLEAR (audit CLEAN: 98 pages, 97 breaks, 120 Contents lines numbered). All 11 subjects (12 streams) done. **Primary 1 Third Term COMPLETE.**

* **Primary 2 First Term — tracker opened + Basic Science authored (1 of 11).** New class started; `PROJECT/81-PRIMARY-2-1ST-TERM.md` records the per-subject week shapes from the master (they vary: BDL has wk7 teaching, SCS has wk12, MATH stream has 7 weeks, GK lists none). Basic Science (wks 1-6,8,9): living and non-living things, plants, animals, the human body, our senses, health and cleanliness, air and water, weather and seasons. sheet_check clean, make_exam --strict PASS (A=8 B=7 C=7 D=8, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 2 First Term — Basic Digital Literacy authored (2 of 11).** Eight weeks (W1-5,7,8,9 — wk6 is a break, wk7 teaches): the computer, computer hardware, computer software, uses of computers, the computer room, the keyboard, the mouse, care of the computer. One fix (wk9 repeated wk5's wires/plugs line — reworded). sheet_check clean, make_exam --strict PASS (A=7 B=8 C=8 D=7, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 2 First Term — Christian Religious Studies authored (3 of 11).** Eight weeks: God the Creator, God's love for us, the Bible (God's word), prayer, Adam and Eve, Noah's ark, Abraham the father of faith, Joseph and God's care. Two fixes (duplicate notebook words 'obey'/'forgive' replaced with week-specific words). sheet_check clean, make_exam --strict PASS (A=7 B=8 C=7 D=8, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 2 First Term — Cultural and Creative Arts authored (4 of 11).** Eight weeks: art (drawing and painting), colours, craft and modelling, music and singing, dance, drama and role play, local crafts, our culture. One fix (duplicate notebook word 'festival' replaced). sheet_check clean, make_exam --strict PASS (A=8 B=7 C=7 D=8, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 2 First Term — General Knowledge authored (5 of 11).** GK Primary 2 uses a term-stream layout; First Term topics came straight from the master: states and capitals by zone (North-Central/North-West, North-East/South-South, South-East/South-West/FCT), how we are governed (local/state/federal), our leaders today, national symbols and their meanings, the colonial era and independence (1 Oct 1960), Nigerian heroes. Four fixes (duplicate notebook words across the states/capitals weeks replaced with zone-specific terms). sheet_check clean, make_exam --strict PASS (A=7 B=8 C=8 D=7, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 2 First Term — Nigerian History authored (6 of 11).** Eight weeks: Nigeria as a country, our people and culture, early Nigerian communities (Nok/Ife/Benin/Kanem-Borno), traditional rulers (Emir/Oba/Obi/Sultan), traditions and festivals, trade in the past (barter/cowries), colonial rule (amalgamation 1914), Nigeria's independence (1 Oct 1960). Clean pass — no polish fixes needed. sheet_check clean, make_exam --strict PASS (A=7 B=7 C=8 D=8, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 2 First Term — Physical and Health Education authored (7 of 11).** Eight weeks: the body and movement, locomotor movements, non-locomotor movements, games and sports, personal hygiene, food and nutrition, safety and simple first aid, rest and sleep. Clean pass — no polish fixes needed. sheet_check clean, make_exam --strict PASS (A=8 B=8 C=7 D=7, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 2 First Term — Prevocational Studies authored (8 of 11).** Eight weeks: work at home and school, tools we use, farm work, care of our things, food preparation, clothing and dressing, caring for our environment, saving and sharing. Clean pass — no polish fixes needed. sheet_check clean, make_exam --strict PASS (A=7 B=8 C=7 D=8, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 2 First Term — Social and Citizenship Studies authored (9 of 11).** Nine weeks (W1-6,8,9,12): the family, our community, rules and regulations, our rights and duties, respect and honesty, living together in peace, our culture and customs, caring for our community, being a good citizen. One fix (duplicate notebook word 'obey' replaced). sheet_check clean, make_exam --strict PASS (A=7 B=8 C=8 D=7, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 2 First Term — Yoruba authored (10 of 11).** Eight weeks: kíkà (counting to 20), àwọ̀ (colours), ẹ̀yà ara (body parts), oúnjẹ (food), ẹranko (animals), ilé àti ohun èlò (home and things), orin (songs), ìtàn (stories). Two 'My own work' blocks got hands verbs (trace); wk1 got an 8th 'Things to know' item. sheet_check clean, make_exam --strict PASS (A=8 B=7 C=7 D=8, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 2 First Term — Mathematics & English authored (11 of 11 — ALL SUBJECTS DONE).** Two streams on the master topics. MATHEMATICS (7 wks): whole numbers up to 999 (parts 1-3), fractions (parts 1-4). ENGLISH LANGUAGE (8 wks): revision of Year One's work, reading and grammar (nouns), speaking and grammar (verbs), reading comprehension and writing, listening and grammar (adjectives), speaking and writing, reading and grammar part 2 (pronouns), writing and handwriting. Thirteen fixes (nine 'My own work' blocks got hands verbs; four duplicate lines reworded). sheet_check clean, both make_exam --strict PASS (MATH A=8 B=7 C=7 D=8; ENG A=7 B=8 C=7 D=8, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 2 First Term — BOOKS BUILT, TERM COMPLETE.** Pupil copy `notes/Primary 2 - First Term.{md,docx}` (112,071 B docx, 99 pages, 97 notes, 12 papers, key n=360 A=89 B=91 C=88 D=92) and teacher copy `notes/Primary 2 - First Term - TEACHER COPY.{md,docx}` (117,688 B docx, 111 pages, paper keys only). Both built --strict, rule checks all clear, gates ALL CLEAR (audit CLEAN: 99 pages, 98 breaks, 120 Contents lines). Note: Yoruba Primary 2 First Term carries 9 teaching weeks (1-6,8,9,11 — wk11 is a revision/exam-prep topic week in the master), so a wk11 revision note was added; the term is 97 notes. All 11 subjects (12 streams) done. **Primary 2 First Term COMPLETE.**

* **Primary 2 Second Term — tracker opened + Basic Science authored (1 of 11).** New term; `PROJECT/82-PRIMARY-2-2ND-TERM.md` records the scheme topics from the master (Primary 2 carries real topics for every subject). Basic Science follows the master: air in motion, quality of water, uses of water, plants I, plants II, animals, forms of technology, forms of technology (light). Clean pass — no polish fixes needed. sheet_check clean, make_exam --strict PASS (A=7 B=7 C=8 D=8, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 2 Second Term — Basic Digital Literacy authored (2 of 11).** Eight weeks on the master topics: interface customization, file management I & II, digital content creation I & II, safety and protection, safe internet use I & II. Four fixes (wk5 hands verb; wk8 grown-up-deputise reworded + duplicate strangers line; wk9 grown-up-deputise reworded). sheet_check clean, make_exam --strict PASS (A=7 B=7 C=8 D=8, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 2 Second Term — Christian Religious Studies authored (3 of 11).** Eight weeks on the master topics: God speaks to us, we are children of one Father, God calls us for a purpose, God gives His law, God reveals Himself (parts 1-2), Jesus' power to forgive sins, Jesus loves all people. Clean pass — no polish fixes needed. sheet_check clean, make_exam --strict PASS (A=7 B=7 C=8 D=8, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 2 Second Term — Cultural and Creative Arts authored (4 of 11).** Eight weeks on the master topics: creating drama from stories, staging a drama, traditional fabrics and their origins (aso-oke/akwaete/a'ngbanya), traditional dresses, traditional fashion accessories, making simple accessories (×2), cultural day preparation. One fix (duplicate notebook word 'accessory' replaced). sheet_check clean, make_exam --strict PASS (A=8 B=7 C=8 D=7, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 2 Second Term — General Knowledge authored (5 of 11).** Eight weeks on the master topics: the seven continents, the five oceans, countries and capitals (Africa), countries and capitals (the world), Nigerian culture (languages/dress/festivals), the human body and healthy habits, plants/animals and their habitats, technology around us. Four fixes (duplicate notebook words across the countries/capitals weeks replaced with capital-city vocabulary). sheet_check clean, make_exam --strict PASS (A=8 B=7 C=7 D=8, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 2 Second Term — Nigerian History authored (6 of 11).** Eight weeks on the master topics: heroes and heroines in the community, national heroes and heroines (parts 1-2), contributions of heroes to development, developing an attitude of selfless service, introduction to traditional authority, traditional rulers, traditional title holders. One fix (duplicate notebook word 'independence' replaced). sheet_check clean, make_exam --strict PASS (A=8 B=7 C=8 D=7, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 2 Second Term — Physical and Health Education authored (7 of 11).** Eight weeks on the master topics: road safety, personal safety and emergency numbers (112), introduction to physical education, moving our body parts (parts 1-2), athletics I (running), athletics II (jumping), ball games I (introduction). Clean pass — no polish fixes needed. sheet_check clean, make_exam --strict PASS (A=8 B=7 C=7 D=8, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 2 Second Term — Prevocational Studies authored (8 of 11).** Eight weeks on the master topics: concept of home economics I & II, personal grooming I & II, care of personal clothing I & II, introduction to food, simple home economics tools I. Clean pass — no polish fixes needed. sheet_check clean, make_exam --strict PASS (A=7 B=7 C=8 D=8, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 2 Second Term — Social and Citizenship Studies authored (9 of 11).** Nine weeks (W1-6,8,9,12) on the master topics: secure environment, local wildlife and conservation, national values, followership, healthy family relationships, people's beliefs and tradition, civic activities, civic activity (volunteerism), secure environment (review). Six fixes (wk12 review bullets reworded so they are distinct from wk1). sheet_check clean, make_exam --strict PASS (A=8 B=7 C=7 D=8, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 2 Second Term — Yoruba authored (10 of 11).** Nine weeks (W1-6,8,9,11) on the master topics: greetings and permission, words and fruits, greetings and singing, counting 151-180 and communication, pronouns and heritage work, proverbs and the market, counting 181-200 and household items, revision, exam preparation. Eight fixes (hands verbs added to My own work; wk8 duplicate line reworded). sheet_check clean, make_exam --strict PASS (A=8 B=7 C=8 D=7, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 2 Second Term — Mathematics-English authored (11 of 11, COMPLETE).** Two streams: MATHEMATICS (8 weeks: addition, subtraction, multiplication, division) and ENGLISH LANGUAGE (8 weeks: reading & phonics, writing & speaking, reading & comprehension, speaking & grammar, reading & vocabulary, writing & grammar, listening & speaking, reading & handwriting). Twelve fixes (subobjective format; duplicate lines reworded). Both papers: sheet_check clean, make_exam --strict PASS, sheet_lint 0, polish 0-to-fix, gates ALL CLEAR. **ALL 11 SUBJECTS COMPLETE.**

* **Primary 2 Second Term — BOOKS BUILT (COMPLETE).** Pupil book 107K, teacher book 112K. All 11 subjects (98 teaching weeks), 12 papers (30/10/5 each), key shape n=360 A=92 B=84 C=92 D=92, consecutive-repeats=0, ABAB=0. Gates ALL CLEAR. **PRIMARY 2 SECOND TERM COMPLETE.**

* **Primary 2 Third Term — Basic Science authored (1 of 11).** Eight weeks on the master topics: change in nature, change in plants, change in animals, water in our environment, the mouth/teeth/tongue, the teeth, rocks, properties of living and non-living things. Clean first pass — no fixes needed. sheet_check clean, make_exam --strict PASS (A=7 B=8 C=7 D=8, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.

* **Primary 2 Third Term — Basic Digital Literacy authored (2 of 11).** Eight weeks on the master topics: phishing awareness, cyberbullying, inclusivity in digital content, basics of programming, introduction to Scratch, coding with Scratch I & II, sequence in programming. Two worksheet-option typos fixed (stray `||` where `D)` belonged). sheet_check clean, make_exam --strict PASS (A=8 B=7 C=7 D=8, exploitable-longest 0), sheet_lint 0, polish 0-to-fix, gates ALL CLEAR.
